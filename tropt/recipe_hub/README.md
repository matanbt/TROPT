...
| **RS-Emb** | Black-box Random Search with coarse-to-fine block mutations toward a target vector. Supports HF and OpenAI encoders. | Encoder (HF / OpenAI) | Loss (Text) | — | [`RSEmb.py`](RSEmb.py) |
