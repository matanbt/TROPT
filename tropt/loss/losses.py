...
class PrefillDistillationLoss(PrefillBasedLoss):
    ...
    Requires `target_response_logits` in the targets -- a tensor of shape
    (target_seq_len, vocab_size) per prompt---usually as generated by the reference
    model when prompted with the task.
    """
