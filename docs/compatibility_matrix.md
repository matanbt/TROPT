...
| Optimizer | Required Mixins | Access Level |
|---|---|---|
...
| Model | Path | ModelOutput fields | ModelInput fields |
|---|---|---|---|
...
| EncoderOpenAIModel | token | *(none)* | `input_texts`, `targets`, `trigger_ids`, `trigger_strs` |
